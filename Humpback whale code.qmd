...
whale_2020 <- ggplot() + 
  ...
  geom_sf(data = humpback_data_2020, color = "darkred", size = 2, show.legend = FALSE) + 
...
whale_2021 <- ggplot() + 
  annotation_map_tile(type = "hotstyle", progress = "none") + 
  geom_sf(data = humpback_data_2021, color = "red", size = 2, show.legend = FALSE) + 
...
whale_2022 <- ggplot() + 
  annotation_map_tile(type = "hotstyle", progress = "none") + 
  geom_sf(data = humpback_data_2022, color = "purple", size = 2, show.legend = FALSE) + 
  labs(title = "Humpback Whale Sightings 2020") +
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5)) +
  coord_sf(xlim = c(-18237508, 18237508), ylim = c(-17037508, 94688)) +
...
whale_2023 <- ggplot() + 
  annotation_map_tile(type = "hotstyle", progress = "none") + 
  geom_sf(data = humpback_data_2023, color = "violetred3", size = 2, show.legend = FALSE) + 
